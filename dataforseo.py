...
class DataForSEO:
    ...
    async def google_ads_search_volume(
        ...
        """Обсяг пошуку (і CPC, якщо доступно) для списку ключів."""
        task = {
            "keywords": keywords,
            "location_name": location_name,
            "language_name": language_name,
    ...
    async def keywords_gap(
        ...
        # правильний endpoint для Google:
        return await self._post_array("/v3/dataforseo_labs/google/keyword_intersections/live", [task])
