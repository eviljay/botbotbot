...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "Звігди береться   інфа:\n"
"Шось береться з google api, шось береться не з Google api, і шось взагалі взагалі не з Google API.\n"
"Цей бот жодним чином не заміна AHREFS, та інфа звідти не береться.\n"
        "Меню:\n"
